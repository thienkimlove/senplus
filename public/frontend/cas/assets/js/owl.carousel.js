 ...
 */"function" != typeof Object.create && (Object.create = function (t) {
  ...
  var i = {
    ...
    updateItems: function () {
      ...
      if (e = t(i.options.responsiveBaseWidth).width(), e > (i.options.itemsDesktop[0] || i.orignalItems) && (i.options.items = i.orignalItems), !1 !== i.options.itemsCustom) for (i.options.itemsCustom.sort(function (t, e) {
        return t[0] - e[0];
    ...
    response: function () {
      var o,
          i,
          n = this;
      return !0 === n.options.responsive && (i = t(e).width(), n.resizer = function () {
    ...
    loops: function () {
      ...
      for (n.positionsInArray = [0], n.pagesInArray = [], e = 0; e < n.itemsAmount; e += 1) a += n.itemWidth, n.positionsInArray.push(-a), !0 === n.options.scrollPerPage && (o = t(n.$owlItems[e]), (i = o.data("owl-roundPages")) !== s && (n.pagesInArray[s] = n.positionsInArray[e], s = i));
    },
    ...
    gestures: function () {
      ...
      function a(n) {
        ...
        l.newPosX = i(r).x - p.offsetX, l.newPosY = i(r).y - p.offsetY, l.newRelativeX = l.newPosX - p.relativePos, "function" == typeof l.options.startDragging && !0 !== p.dragging && 0 !== l.newRelativeX && (p.dragging = !0, l.options.startDragging.apply(l, [l.$elem])), (l.newRelativeX > 8 || l.newRelativeX < -8) && !0 === l.browser.isTouch && (void 0 !== r.preventDefault ? r.preventDefault() : r.returnValue = !1, p.sliding = !0), (l.newPosY > 10 || l.newPosY < -10) && !1 === p.sliding && t(o).off("touchmove.owl"), s = function () {
          return l.newRelativeX / 5;
        }, a = function () {
          return l.maximumPixels + l.newRelativeX / 5;
        }, l.newPosX = Math.max(Math.min(l.newPosX, s()), a()), !0 === l.browser.support3d ? l.transition3d(l.newPosX) : l.css2move(l.newPosX);
      }
      ...
      function r(o) {
        ...
        r.target = r.target || r.srcElement, p.dragging = !1, !0 !== l.browser.isTouch && l.$owlWrapper.removeClass("grabbing"), l.newRelativeX < 0 ? l.dragDirection = l.owl.dragDirection = "left" : l.dragDirection = l.owl.dragDirection = "right", 0 !== l.newRelativeX && (i = l.getNewPosition(), l.goTo(i, !1, "drag"), p.targetElement === r.target && !0 !== l.browser.isTouch && (t(r.target).on("click.disable", function (e) {
