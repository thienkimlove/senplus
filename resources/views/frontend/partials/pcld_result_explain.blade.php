...
@if ($explain['details'][2]['lessThan'])
    <div>
        Có {{ count($explain['details'][2]['lessThan']) }} sự chênh lệch nhỏ hơn 10 và lớn hơn hoặc bằng 5, thể hiện nhu cầu thay đổi cần lưu ý của họ đó là:
    </div>
    <div>
        <ul>
...
<div>
    Theo đánh giá của nhóm thì phong cách lãnh đạo hiện tại {{ \App\Helpers::getMatchName($explain['extends'][2]['percentMatch']) }} ({{$explain['extends'][2]['percentMatch']}}%)
