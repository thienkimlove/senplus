...
@if ($explain['details'][3]['lessThan'])
    <div>
        Có {{ count($explain['details'][3]['lessThan']) }} sự chênh lệch nhỏ hơn 10 và lớn hơn hoặc bằng 5, thể hiện nhu cầu thay đổi cần lưu ý của họ đó là:
    </div>
    <div>
        <ul>
...
<div>
    Theo đánh giá của nhóm thì cách quản lý nhân viên hiện tại {{ \App\Helpers::getMatchName($explain['extends'][3]['percentMatch']) }} ({{$explain['extends'][3]['percentMatch']}}%)
