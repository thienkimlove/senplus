    ...
    <div class="popupContent pa">
        ...
        <div class="content">
            ...
            <div class="getReady">
                <div class="left">
                    <span class="iconTick">
                        <img src="/frontend/assets/img/tick.png" alt="" class="imgFull">
                    </span>
                    <span>và .. bạn đã sẵn sàng</span>
                </div>
                <a href="{{ route('frontend.home') }}" class="btn_Next" title="Tiếp theo">
                    <img src="/frontend/assets/img/i_next.png" alt="" class="imgFull">
                </a>
            </div>
        </div>
        <div class="popupBot">
            <a href="javascript:void(0)" class="btn-back" title="Quay lại" onclick="window.history.back()">
            ...
            <div id="processing">
                ...
                <span class="moc moc2"><i>Vòng 1</i></span>
                <span class="moc moc3"><i>Vòng 2</i></span>
                <span class="moc moc4"><i>Báo cáo</i></span>
            </div>
            <a href="{{ route('frontend.home') }}" class="btn-next" title="Tiếp tục">
                <img src="/frontend/assets/img/btn-next.png" alt="" class="imgFull">
            </a>
        </div>
    </div>
</div>
<div class="popup px popupGuidings" id="popupGuidings2">
    <div class="bg_drop pa"></div>
    <div class="popupContent pa">
        <a href="javascript:void(0)" class="closePopup pa" title="Đóng lại" aria-label="Close">
            <img src="/frontend/assets/img/i_x.png" alt="" class="imgFull">
        ...
        <div class="content">
            ...
            <div class="getReady">
                <div class="left">
                    <span class="iconTick">
                        <img src="/frontend/assets/img/tick.png" alt="" class="imgFull">
                    </span><span>và .. bạn đã sẵn sàng</span>
                </div>
                <a href="javascript:void(0)" class="btn_Next" title="Tiếp theo">
                    <img src="/frontend/assets/img/i_next.png" alt="" class="imgFull">
                </a>
            </div>
        </div>
        <div class="popupBot">
            ...
            <a href="javascript:void(0)" class="btn-next" title="Tiếp tục">
                <img src="/frontend/assets/img/btn-next.png" alt="" class="imgFull">
            </a>
        </div>
    </div>
...
<div class="popup px popupNotify" id="popupDelSurvey">
    ...
    <div class="popupContent pa box">
        ...
        <div class="form-group">
            ...
            <button type="button" class="myBtn btnDelete">Xóa</button>
        </div>
    </div>
</div>
<div class="popup px popupNotify" id="popupSuccess">
    <div class="bg_drop pa"></div>
    <div class="popupContent pa box">
        <a href="javascript:void(0)" class="closePopup pa" title="Đóng lại" aria-label="Close">
            <img src="/frontend/assets/img/i_x.png" alt="" class="imgFull">
        </a>
        <div class="colorBlue fz18px">Chúc mừng bạn đã hoàn thành khảo sát </div>
        <input id="linkCopy" type="text" value="http://senplus.bosana.vn/abcxyz">
        <div class="form-group">
            <button type="button" class="skip myBtn">Bỏ qua</button>
            <button type="button" class="myBtn btnCopy" onclick="copyLink('#linkCopy')">Copy link</button>
        </div>
    </div>
</div>
